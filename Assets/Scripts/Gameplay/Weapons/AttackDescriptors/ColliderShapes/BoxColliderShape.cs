...
#region Variables (serialized)
	...
	{
		Vector3 gizmoOrigin = attackOrigin + m_offset;

		Handles.Label(gizmoOrigin, colliderName, new GUIStyle() { });

		Handles.matrix = Matrix4x4.TRS(Vector3.zero, orientation, Vector3.one);
		Handles.color = Color.blue;
		Handles.DrawWireCube(gizmoOrigin, m_halfDimensions * 2.0f);
	}
#endif
