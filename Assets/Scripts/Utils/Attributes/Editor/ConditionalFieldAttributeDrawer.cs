...
public class ConditionalFieldAttributeDrawer : PropertyDrawer
{
	...
	/// </summary>
	private static readonly Dictionary<Type, Type> _allPropertyDrawersInDomain = new Dictionary<Type, Type>();
	...
	private void Initialize(SerializedProperty property)
	{
		...
		{
			if (_allPropertyDrawersInDomain.Count != 0)
				return;
...
public static class ConditionalFieldUtility
{
	...
	public static bool PropertyIsVisible(SerializedProperty property, bool inverse, string[] compareAgainst)
	{
		...
		bool IsFlagsEnum()
		{
			...
			var value = EditorExtensions.GetTargetObjectOfProperty(property);
	...
	private static string AsStringValue(this SerializedProperty property)
	{
		switch (property.propertyType)
		{
			...
			case SerializedPropertyType.Enum:
				return EditorExtensions.GetTargetObjectOfProperty(property).ToString();
